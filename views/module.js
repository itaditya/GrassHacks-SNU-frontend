angular.module('ClubPortal', ['ngRoute', 'auth', 'events', 'club', 'arena', 'LocalStorageModule', 'ngFileUpload', 'ui.bootstrap.datetimepicker', 'ngScrollTo', 'timer', 'ngSanitize', 'ng-token-auth']).config(function(localStorageServiceProvider, $locationProvider) {
    // 'ng-token-auth'
...
}).config(function($routeProvider, ngScrollToOptionsProvider, $authProvider) {
    $routeProvider.when('/', {
    ...
    $authProvider.configure({
        apiUrl: 'https://club-portal.herokuapp.com/api/v1',
        validateOnPageLoad: false,
        change_headers_on_each_request : false
        // emailRegistrationPath: '/student'
    });
